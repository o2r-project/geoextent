...
def test_shapefile_extract_bbox():
    result = geoextent.fromFile('testdata/shapefile/Abgrabungen_Kreis_Kleve_Shape.shp', bbox=True, tbox=False)
...
def test_shapefile_extract_time():
    result = geoextent.fromFile('testdata/shapefile/Abgrabungen_Kreis_Kleve_Shape.shp', bbox=False, tbox=True)
